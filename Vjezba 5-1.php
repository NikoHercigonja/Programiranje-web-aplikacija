...
<body>
    ...
    <aside>
        ...
        if (!empty($_COOKIE['news_title_1'])) {
            print '<li style="border-bottom:2px dotted white;width:100%;"><a href="index.php?menu=2&action=1">' . $_COOKIE['news_title_1'] . '</a></li>';
        }

        if (!empty($_COOKIE['news_title_2'])) {
            print '<li style="border-bottom:2px dotted white;width:100%;"><a href="index.php?menu=2&action=2">' . $_COOKIE['news_title_2'] . '</a></li>';
        }

        if (!empty($_COOKIE['news_title_3'])) {
            print '<li style="border-bottom:2px dotted white;width:100%;"><a href="index.php?menu=2&action=3">' . $_COOKIE['news_title_3'] . '</a></li>';
        }
